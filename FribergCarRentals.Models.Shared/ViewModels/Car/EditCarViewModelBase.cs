...
using FribergCarRentals.Shared.ViewModels.Image;
...
namespace FribergCarRentals.Shared.ViewModels.Car
{
    ...
    public abstract class EditCarViewModelBase<TUploadedImage> : CarViewModelBase where TUploadedImage : class
    {
        ...
        {
            VehiclePropulsions = Enum.GetValues<VehiclePropulsionType>().Select(x => new VehiclePropulsionViewModel((int)x, GetAttribute<EnumDatabaseValueAttribute>().Value, GetAttribute<EnumDatabaseValueAttribute>().Description
        }
