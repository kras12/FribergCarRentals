...
namespace FribergCarRentals.Data.Migrations
{
    ...
    [Migration("20240121210053_Modified car rental statuses")]
    partial class Modifiedcarrentalstatuses
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FribergCarRentals.DataAccess.EntityClasses.CarOrderEntity", b =>
                {
                    b.Property<int>("CarOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FribergCarRentals.DataAccess.EntityClasses.CarRentalStatusEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CarRentalStatusId = 5,
                            StatusDescription = "Has been returned.",
                            StatusName = "Returned"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("FribergCarRentals.DataAccess.EntityClasses.CustomerEntity", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FribergCarRentals.DataAccess.EntityClasses.ImageEntity", b =>
                {
            ...
            modelBuilder.Entity("FribergCarRentals.DataAccess.EntityClasses.PaymentEntity", b =>
                {
            ...
            modelBuilder.Entity("FribergCarRentals.DataAccess.EntityClasses.VehiclePropulsionEntity", b =>
                {
            ...
            modelBuilder.Entity("FribergCarRentals.DataAccess.EntityClasses.CarBookingEntity", b =>
                {
                    b.HasOne("FribergCarRentals.DataAccess.EntityClasses.CarEntity", "Car")
                        .WithMany()
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FribergCarRentals.DataAccess.EntityClasses.CarOrderEntity", "CarOrder")
            ...
            modelBuilder.Entity("FribergCarRentals.DataAccess.EntityClasses.CarEntity", b =>
                {
                    ...
                    b.HasOne("FribergCarRentals.DataAccess.EntityClasses.CarRentalStatusEntity", "RentalStatus")
                        .WithMany()
            ...
            modelBuilder.Entity("FribergCarRentals.DataAccess.EntityClasses.CarOrderEntity", b =>
                {
                    b.HasOne("FribergCarRentals.DataAccess.EntityClasses.CustomerEntity", "Customer")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("FribergCarRentals.DataAccess.EntityClasses.ImageEntity", b =>
                {
                    b.HasOne("FribergCarRentals.DataAccess.EntityClasses.CarEntity", null)
                        .WithMany("Images")
            ...
            modelBuilder.Entity("FribergCarRentals.DataAccess.EntityClasses.PaymentEntity", b =>
                {
                    b.HasOne("FribergCarRentals.DataAccess.EntityClasses.CarOrderEntity", "Order")
                        .WithMany("Payments")
